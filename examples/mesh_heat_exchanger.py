...
geom.add_physical_surface(mouth_inlet1, INMOUTH1)
geom.add_physical_surface(mouth_inlet2, INMOUTH2)
geom.add_physical_surface(mouth_outlet1, OUTMOUTH1)
geom.add_physical_surface(mouth_outlet2, OUTMOUTH2)
geom.add_physical_surface([main_rect, mouth_outlet2, mouth_outlet1], DOMAIN)
